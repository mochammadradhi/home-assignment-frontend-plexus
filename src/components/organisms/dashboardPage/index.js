...
const DashboardPage = (props) => {
  ...
  return (
    ...
    <Navbar/>
      <section className="pt-24 pb-12  w-full h-[80vh] laptop:h-max">
        <div className="max-w-[1200px] flex flex-wrap laptop:flex-col mx-auto relative ">
          <div className=" laptop:basis-full laptop:mx-auto laptop:p-5 basis-1/3 ">
            ...
            <p className="text-sm my-4 leading-tight tracking-wide font-normal">Lorem ipsum dolor sit amet consectetur adipisicing elit. Cum fugit dolore consequatur eos? Quaerat obcaecati veritatis cum eligendi temporibus explicabo!</p>
            <button className="bg-[#3E5B5D] text-white font-medium p-3">About Us</button>          
          </div>
          <div className="laptop:basis-full basis-2/3 laptop:p-5">
            <div className="rounded-t-full bg-contain bg-right-top h-[50vh] bg-no-repeat bg-[url('https://images.unsplash.com/photo-1586023492125-27b2c045efd7?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=958&q=80')] relative left-[-150px]"></div>
          </div>
      ...
      */}
      <section className="py-24  bg-[#273a3b]">
